...
HD_PWD='C:/Mac/Home/Desktop/NANO_PROCESSOR/NANO_PROCESSOR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux_8W_4B.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mux_8W_4B.tcl -notrace
