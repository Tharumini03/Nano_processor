...
HD_PWD='C:/Mac/Home/Desktop/NANO_PROCESSOR/NANO_PROCESSOR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux_8W_4B.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux_8W_4B.tcl
