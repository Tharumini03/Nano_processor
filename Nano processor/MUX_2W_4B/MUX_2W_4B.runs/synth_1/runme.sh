...
HD_PWD='C:/Mac/Home/Desktop/MUX_2W_4B/MUX_2W_4B.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux_2W_4B.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux_2W_4B.tcl
