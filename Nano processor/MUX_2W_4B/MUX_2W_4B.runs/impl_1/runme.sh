...
HD_PWD='C:/Mac/Home/Desktop/MUX_2W_4B/MUX_2W_4B.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux_2W_4B.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mux_2W_4B.tcl -notrace
